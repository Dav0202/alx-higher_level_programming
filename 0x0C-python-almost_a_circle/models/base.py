""" Base Class for Geometry Rectangle and Square """
...
class Base:
    ...
    def draw(list_rectangles, list_squares):
        ...
        def drawfig(x, y, widthfig, heightfig, xoffset, yoffset, color,
            ...
            for i in range(height):
                for j in range(width):
                    rg.dot(dz, "black")
                    rg.forward(dd)
                rg.backward(dd * width)
                rg.right(mov)
                rg.forward(dd)
                rg.left(mov)

            rg.goto(xoffset, -1 * y * dd + yoffset)
            ...
            rg.goto(x * dd + xoffset, -1 * y * dd + yoffset)
        ...
        for r in list_rectangles:
            ...
            x, y = r.x, r.y
            drawfig(x, y, width, height, xoffset, yoffset, colors[cl], dd, rg)
